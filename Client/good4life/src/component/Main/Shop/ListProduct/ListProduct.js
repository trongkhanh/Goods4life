...
import sp1 from '../../../../media/temp/apple.jpg';
            ...
            <View style={container}>
                <ScrollView style={wrapper}>
                    <View style={header}>
                        ...
                        <Text style={titleStyle}>Hoa quả tươi</Text>
                        <View style={{ width: 30 }} />
                    </View>
                    <View style={productContainer}>
                        <Image style={productImage} source={sp1} />
                        <View style={productInfo}>
                            <Text style={txtName}>Táo Hải Dương</Text>
                            <Text style={txtPrice}>10$</Text>
                            <Text style={txtMaterial}>Giàu vitamin</Text>
                            <View style={lastRowInfo}>
                                <Text style={txtColor}>Táo Xanh</Text>
